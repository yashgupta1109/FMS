...
if($row>0)
{
    ...
    $msg=mysqli_query($con,"insert into admin(fname,lname,email,designation,password) values('$fname','$lname','$email','$designation','$password', '$mobile', '$dept')");
...
<head>
    ...
    <title>Add Admin | JSSATEN-SIM</title>
