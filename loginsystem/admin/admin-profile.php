...
<head>
    ...
    <title>Admin Profile | JSSATEN-SIM</title>
...
{?>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <a href="edit-admin-profile.php?uid=<?php echo $result['id'];?>">Edit</a>
                    ...
                    <div class="p-2 bd-highlight  d-flex justify-content-center">
                            <div class="d-flex flex-column bd-highlight mb-3">
                                <div class="p-2 bd-highlight">
                                    ...
                                    <?php 
			$q=mysqli_query($con,"select img from admin where id='".$_SESSION['adminid']."'");
