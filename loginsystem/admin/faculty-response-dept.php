                                                                                                                                        ...
                                                                                                                                        <form method="post" style="border: 0;">
                                                                                                                                            <table class="table table-hover">
                                                                                                                                                <tr?>
                                                                                                                                                    ...
                                                                                                                                                    <td><input name="deptsub" type="submit" value="Submit" class="btn btn-success" /></td>
    ...
    <span style='font-size:22px;'>"
                                        ...
                                        <th>Semester Type</th> -->
                                                                                                                                            ...
                                                                                                                                            <?php //Updated Here
                                                                                                                                                ...
                                                                                                                                                $sql8 = "SELECT f_results.* FROM f_results JOIN faculty ON f_results.facultyemail = faculty.email WHERE faculty.department = 'Information Technology'";
