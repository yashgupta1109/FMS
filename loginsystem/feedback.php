...
// $result = mysqli_query($con, $r);
                        ...
                        if (isset($_POST['insert'])) {
                            ...
                            $sql2 = "select * from f_results where suballoted = '$subCode' and section = (select section from users where id= '$id1')";
                            ...
                            //Updated Here
                            $sql8 = "UPDATE f_results JOIN (SELECT facultyemail, subjectcode, AVG(co1) AS co1_avg, AVG(co2) AS co2_avg, AVG(co3) AS co3_avg, AVG(co4) AS co4_avg, AVG(co5) AS co5_avg, AVG(sb1) AS sb1_avg, AVG(sb2) AS sb2_avg, AVG(sb3) AS sb3_avg, AVG(sb4) AS sb4_avg, AVG(sb5) AS sb5_avg, AVG(co6) AS co6_avg FROM respone GROUP BY facultyemail, subjectcode ) AS r ON f_results.facultyemail = r.facultyemail AND f_results.suballoted = r.subjectcode SET f_results.co1 = r.co1_avg * 1.67, f_results.co2 = r.co2_avg * 1.67, f_results.co3 = r.co3_avg * 1.67, f_results.co4 = r.co4_avg * 1.67, f_results.co5 = r.co5_avg * 1.67, f_results.co6 = r.co6_avg * 1.67, f_results.OVERALL = (r.sb1_avg + r.sb2_avg + r.sb3_avg + r.sb4_avg + r.sb5_avg) / 4; ";
