...
$sql=mysqli_query($con,"SELECT password FROM faculty where password='$oldpassword'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
$facultyid=$_SESSION['facultyid'];
$ret=mysqli_query($con,"update faculty set password='$newpassword' where id='$facultyid'");
...
<html lang="en">
    <head>
        ...
        <title>Change password | JSSATEN-SIM</title>
