...
<html lang="en">
    <head>
        ...
        <title>Student Profile | JSSATEN-SIM</title>
...
{?>
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item"><a href="manage-users.php">Manage Students</a></li>
                        <li class="breadcrumb-item active">Student's Profile</li>
                    </ol>
                        <div class="card mb-4">
                     
                            <div class="card-body">
                                <a href="edit-users-profile.php?uid=<?php echo $result['id'];?>">Edit</a>
